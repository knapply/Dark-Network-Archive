...
tags: 
- terrorism
summary: "The present data depict the network of individuals involved in the 2000 Christmas Eve series of high-scale terrorist attack by Al Qaeda and Jemaah Islamiyah. This series of attacks ook plack accross various churches in Jakarta, claiming the lives of 18 people. The authors of these dataset, JJATT, gathered these data from using 'open source' information. The present dataset reflects a combination of familial, frienship, and association relationships. Furthermore, as a dynamic dataset these relationships are depicted as dynamic and subject to changes."
---
...
```{r}
proto_net <- COREnets::get_data("christmas_eve_bombings_2000")
...
for (i in seq_along(vis_nets)) {
 htmlwidgets::saveWidget(
   vis_nets[[i]],
   file = sprintf("%s/Christmas Eve bombings 2000, Indonesia%s.html", temp_dir, i)
  )
}

vis_paths <- dir(temp_dir, pattern = "Christmas Eve bombings 2000, Indonesia\\d+\\.html$",
                 full.names = TRUE)
