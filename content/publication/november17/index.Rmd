...
for (i in seq_along(vis_nets)) {
 htmlwidgets::saveWidget(
   vis_nets[[i]],
   file = sprintf("%s/November17%s.html", temp_dir, i)
  )
}

vis_paths <- dir(temp_dir, pattern = "November17\\d+\\.html$",
                 full.names = TRUE)
