...
image:
  caption: "[Wikipedia](https://en.wikipedia.org/wiki/Dumbledore%27s_Army#/media/File:Harrypotter5-roomofrequirement.jpg)"
  focal_point: ""
  preview_only: false
tags: 
- trust
...
for (i in seq_along(vis_nets)) {
 htmlwidgets::saveWidget(
   vis_nets[[i]],
   file = sprintf("%s/Dumbledore's Army%s.html", temp_dir, i)
  )
}

vis_paths <- dir(temp_dir, pattern = "Dumbledore's Army\\d+\\.html$",
                 full.names = TRUE)
